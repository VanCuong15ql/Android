 ...
 * Use the [ast.newInstance] factory method to
...
class ast : Fragment() {
    ...
    override fun onCreateView(
        ...
        btnSave.setOnClickListener {
            ...
            val student = StudentModel(name, studentId)
            val activity = requireActivity()

            if (activity is SaveListener)
                (activity as SaveListener).add(name, studentId)
...
//                .commit()
    ...
    companion object {
         ...
         * @return A new instance of fragment ast.
         */
